...
using AuctionService.Unit.Tests.Utils;
using AutoFixture;
using AutoMapper;
using MassTransit;
...
public class AuctionsControllerTests 
{
    ...
    [Fact]
    public async Task GetAuctionById_WithValidGuid_ReturnsAuctionAsync() // Method_Scenario_ExpectedResult()
    {
        // arrange
    ...
    [Fact]
    public async Task GetAuctionById_WithInvalidGuid_ReturnsNotFound() // Method_Scenario_ExpectedResult()
    {
        // arrange
    ...
    [Fact]
    public async Task CreateAuction_WithValidCreateAuctionDto_ReturnsCreatedAtAction() // Method_Scenario_ExpectedResult()
    {
        // arrange
